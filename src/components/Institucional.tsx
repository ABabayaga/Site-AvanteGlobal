...
function Institucional() {
  const quemSomosScope = useScrollReveal<HTMLElement>()
  const missaoScope = useScrollReveal<HTMLElement>()
  const timeScope = useScrollReveal<HTMLElement>()

  return (
    <>
      <section ref={quemSomosScope} className="bg-ice py-24 font-hero max-lg:py-14" id="institucional">
      ...
      <section ref={missaoScope} className="bg-ice py-24 font-hero max-lg:py-14" id="nossa-missao">
        <div className="mx-auto max-w-360 px-10 max-lg:px-5">
      ...
      <section ref={timeScope} className="bg-cream py-24 font-hero max-lg:py-14" id="nosso-time">
        <div className="mx-auto max-w-360 px-10 text-center max-lg:px-5">
          ...
          <h2
            data-reveal
            className="mx-auto mb-4 max-w-160 text-[44px] leading-[1.15] font-extrabold tracking-[-0.5px] text-navy-deep max-lg:text-3xl"
          >
          ...
          <p
            data-reveal
            className="mx-auto mb-14 max-w-160 text-lg text-text max-lg:mb-10 max-lg:text-base"
          >
