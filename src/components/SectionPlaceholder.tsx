...
function SectionPlaceholder({ id, eyebrow, title, text }: SectionPlaceholderProps) {
  ...
  return (
    <section ref={scope} className="bg-ice py-24 font-hero max-lg:py-14" id={id}>
      <div className="mx-auto max-w-360 px-10 max-lg:px-5">
        ...
        <div data-reveal className="mb-14 max-w-160 border-t-4 border-sky-accent pt-4 max-lg:mb-10">
